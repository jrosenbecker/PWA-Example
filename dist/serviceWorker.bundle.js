...
var VERSION = '1';
var CACHE_NAME = 'demo-pwa-' + VERSION;

var urlsToCache = ['/', '/caching-strategies.html', '/push-notifications.html', '/web-share-api.html', '/dist/app.bundle.js', '/dist/styles.bundle.js', '/node_modules/materialize-css/dist/css/materialize.css'];
...
function cacheFirst(request) {
    return caches.match(request).then(function (cachedResponse) {
        ...
        updateCache(request).then(function (response) {
            return response;
        });
    });
}
